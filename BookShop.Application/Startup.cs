...
namespace BookShop.Application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DbContext, DatabaseContext>(opts => opts.UseSqlServer(Configuration["ConnectionString:bookshop"]));

            services.AddTransient<IBookRepository, BookRepository>();
            services.AddTransient<IRepository<Genre>, BaseRepository<Genre>>();
            services.AddTransient<IRepository<Author>, BaseRepository<Author>>();
